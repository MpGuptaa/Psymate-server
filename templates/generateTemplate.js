const generateBookingTemplate = (content) => {
  const {
    patientName,
    patientNumber,
    patientEmail,
  ...
  return `
        ...
        <body class="email">
            <div class="email__container">
                ...
                <main>
                    <p class="email__p">
                        Booking Confirmation for appointment booked at Psymate Clinic through our exclusive portal. 
                    </p>
                    <p class="email__p">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="table__email" href="mailto:${
                                          patientEmail || ""
                                        }">${patientEmail || ""}</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                <td>Location</td>
                                <td class="table__detail">${address || ""}</td>
                            </tr>
                            </tr>
                            </tbody>
                        </table>
...
module.exports = { generateBookingTemplate };
