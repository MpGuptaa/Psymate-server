  ...
  <body>
    <section>
      ...
      <header style="margin: 1rem 0 !important">
        <div style="width: 70%; padding: 0 1rem 0 0">
          <p>Patient Name: ${user.displayName || ""}</p>
          <p>Age: ${user.age || ""}</p>
          <p>Gender: ${user.gender || ""}</p>
          <p>Phone: ${user.phone || ""}</p>
        </div>
        <div style="width: 20%; padding: 0 0 0 1rem; text-align: left">
      ...
      >
        <div
          style="width: 55%; text-align: left; padding: 2rem 0; display: flex"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="Capa_1"
          ...
          <p style="margin-left: 10px; font-size: large">
    ...
    <article>
      ...
      <table class="inventory">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <span data-prefix
                >${content?.payment?.[0]?.currency || "Rs."}</span
      ...
      <section style="border-bottom: 0.4px solid black; width: 100%">
        <table class="balance">
          <tr>
          ...
          <div style="max-width: 30%; padding: 0 1rem">
            ...
            >
              ...
              <g>
                <g>
                  <path
                    d="M32.139,20.116c-6.441,8.563-10.148,19.077-10.148,30.199v411.358c0,11.123,3.708,21.636,10.148,30.199l235.877-235.877    L32.139,20.116z"
                  />
                </g>
              </g>
              <g>
                <g>
                  <path
                    d="M464.261,212.087l-67.266-37.637l-81.544,81.544l81.548,81.548l67.273-37.64c16.117-9.03,25.738-25.442,25.738-43.908    S480.389,221.117,464.261,212.087z"
                  />
                </g>
              </g>
              <g>
                <g>
                  <path
                    d="M291.733,279.711L60.815,510.629c3.786,0.891,7.639,1.371,11.492,1.371c9.522,0,19.011-2.708,27.31-8.07l266.965-149.372    L291.733,279.711z"
                  />
                </g>
              </g>
              <g></g>
